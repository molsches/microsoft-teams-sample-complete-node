...
export const DialogMatches = {
    ...
    O365ConnectorCardActionsDialogMatch: /patient context card/i,
    O365ConnectorCardDialogMatch: /analytics/i,
    ...
    QuizQ1DialogMatch: /today/i,
    QuizQ2DialogMatch: /get patient/i,
